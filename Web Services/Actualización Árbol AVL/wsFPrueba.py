...
def arbolVueloAVL():
    ...
    aereopuerto.raizVuelo=aereopuerto.insertarAVLVUELOS(aereopuerto.raizVuelo,fechaLlegada, fechaHoraSalida, fechaHoraLlegada, primeraClase, claseTurista, claseEjecutivo, estadoInicial, idUnico,0)
    aereopuerto.DOT(aereopuerto.raizVuelo)
    aereopuerto.archivoDOTAEREOPUERTO(aereopuerto.archivoDOT+ aereopuerto.datoDOT+ aereopuerto.archivodDOTCIERRE)
    aereopuerto.datoDOT="" #limpio variable
    print(json)
    return jsonify(json)
